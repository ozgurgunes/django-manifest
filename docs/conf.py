# -*- coding: utf-8 -*-
#
# Django Manifest documentation build configuration file, created by
...
htmlhelp_basename = 'DjangoManifestdoc'
...
latex_documents = [
  ('index', 'DjangoManifest.tex', u'Django Manifest Documentation',
